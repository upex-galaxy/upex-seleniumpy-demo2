...
class Test_GX3_109_ToolsQA_BookStore:
    ...
    def test_filter_books_in_search_bar(self, precondition):
        ...
        # Processing/extracting the data from the table in the url
        queries = do.get_table_data(ordered_by='titles')
        
        # Typing two letter to find books in searchbar
        ...
        for query in queries:
            ...
            # Start comparing the results from index 1 to the end of the cells
            for result in search_results_texts[1:]:  
